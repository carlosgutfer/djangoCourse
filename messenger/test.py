...
class ThreadTestCase(TestCase):
    def setUp(self):
        self.user1 = User.objects.create_user('user1', None, 'holamundo')
        self.user2 = User.objects.create_user('user2', None, 'holamundo')
        self.user3 = User.objects.create_user('user3', None, 'holamundo')
    ...
    def test_add_messages_to_thread(self):
        ...
        message2 = Message.objects.create(user=self.user2, content= "adios")
